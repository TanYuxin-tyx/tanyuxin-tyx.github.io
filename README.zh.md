...
### [我的博客在这里 &rarr;](https://yuxintan.github.io)
...
我的博客仓库——`yuxintan.github.io`，是经常修改的，而且还会有人乱提交代码，因此给大家做了一个稳定版的模板。大家可以直接fork模板——`huxblog-boilerplate`,要改的地方我都说明了。或者可以直接下载zip到本地自己去修改。
...
* 解决了代码过长自动换行的bug,替换为横向滚动条。详情请见[issue#15](https://github.com/Tanyuxinpro/huxpro.github.io/issues/15)
...
```
# Site settings
title: Tanyuxin Blog             # 你的博客网站标题
SEOTitle: Tanyuxin Blog			# 在后面会详细谈到
...
标题底图是可以自己选的，看看几篇示例post你就知道如何设置了。在
  [issue #6 ](https://github.com/Tanyuxinpro/huxpro.github.io/issues/6) 中我被问到：怎么样才能让标题底图好看呢？
...
我的博客标题是 **“Tanyuxin Blog”** 但是我想要在搜索的时候显示 **“Yuxin的博客 | Yuxin Blog”** ，这个就需要SEO Title来定义了。
