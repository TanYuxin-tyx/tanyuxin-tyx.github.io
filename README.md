...
### [View Live Tanyuxin Blog &rarr;](https://huangxuan.me)
...
```
$ git clone git@github.com:yuxintan/yuxintan.github.io.git
```

**[View Boilerplate Here &rarr;](https://yuxintan.github.io/huxblog-boilerplate/)**
...
## Translation
 ...
 - ![cn](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/China.png) **Chinese (Simplified)**: 感谢 [@BrucZhaoR](https://github.com/BruceZhaoR) 的 [中文翻译 &rarr;](https://github.com/Tanyuxinpro/huxpro.github.io/blob/master/README.zh.md)
...
- Fixed [issue#15](https://github.com/Tanyuxinpro/huxpro.github.io/issues/15) about code wrap.
...
```
# Site settings
title: Tan Yuxin Blog       # title of your website
SEOTitle: Tan Yuxin Blog    # check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: yuxintan     # modify this account to yours
weibo_username: tanyuxin      # the footer woule be auto-updated.
...
Change header images of any pages or any posts is pretty easy as mentioned above. But, thanks to [issue #6 (in Chinese)](https://github.com/Tanyuxinpro/huxpro.github.io/issues/6) asked, **how to make it looks great?**
...
It's possible that you want the two things different. For me, my site-title is **“Tanyuxin Blog”** but I want the title shows in search engine is **“Yuxin的博客 | Yuxin Blog”** which is multi-language.
...
Apache License 2.0.
Copyright (c) 2015-2016 Tanyuxinpro

Tanyuxin Blog is derived from [Clean Blog Jekyll Theme (MIT License)](https://github.com/BlackrockDigital/startbootstrap-clean-blog-jekyll/)
